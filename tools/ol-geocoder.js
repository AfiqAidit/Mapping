...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      (global.Geocoder = factory(
        ...
        global.ol.style.Style,
        global.ol.style.Icon,
        global.ol.layer.Vector,
        global.ol.source.Vector,
        global.ol.geom.Point,
        global.ol.Feature,
        global.ol.proj
      )));
})(
  ...
  function (
    ...
    var SourceVector__default =
      /*#__PURE__*/ _interopDefaultLegacy(SourceVector);
      ...
      getParameters(options) {
        ...
        return {
          ...
          params: {
            ...
            lang: this.settings.langs.includes(options.lang)
              ? options.lang
      ...
      getParameters(opt) {
        return {
          ...
          params: {
            ...
            "accept-language":
              opt.lang || this.settings.params["accept-language"],
          },
        };
      }
      ...
      getParameters(options) {
        return {
          ...
          params: {
            ...
            limit: options.limit || this.settings.params.limit,
            countrycodes:
              options.countrycodes || this.settings.params.countrycodes,
    ...
    class Nominatim {
      ...
      setListeners() {
        const openSearch = (evt) => {
          ...
          if (hasClass(this.els.control, klasses.glass.expanded)) {
            this.collapse();
          } else {
            this.expand();
          }
      ...
      chosen(place, addressHtml, addressObj, addressOriginal) {
        ...
        const coord = proj__namespace.transform(
          coord_,
          "EPSG:4326",
          projection
        );
        ...
        if (
          ...
          this.options.preventMarker === true
        ) {
          // No display change
        ...
        if (
          this.options.preventDefault !== true &&
          this.options.preventPanning !== true
        ) {
      ...
      createFeature(coord) {
        const feature = new Feature__default["default"](
          new Point__default["default"](coord)
        );
      ...
      addressTemplate(address) {
        ...
        if (address.name) {
          html.push(
            ['<span class="', klasses.road, '">{name}</span>'].join("")
          );
        }
      ...
      expand() {
        ...
        addClass(this.els.search, klasses.glass.active);
      ...
      collapse() {
        ...
        removeClass(this.els.search, klasses.glass.active);
      ...
      clearSource() {
        return this.layer.getSource().clear();
      }
